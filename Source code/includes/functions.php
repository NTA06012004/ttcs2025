...
// Đường dẫn này giả định thư mục phpmailer nằm ngay trong thư mục includes
require_once __DIR__ . '/PHPMailer/src/PHPMailer.php';
require_once __DIR__ . '/PHPMailer/src/SMTP.php';
require_once __DIR__ . '/PHPMailer/src/Exception.php';

// Và bạn vẫn cần khai báo 'use' nếu các class đó nằm trong namespace
...
function sendPasswordResetEmail($recipient_email, $recipient_name, $reset_link) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'win10pro.2004+edu@gmail.com';
        $mail->Password   = 'esry yozy wwfg kypw';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587; // Hoặc 465 nếu dùng SMTPS

        // Người gửi và người nhận
        $mail->setFrom('win10pro.2004+edu@gmail.com', 'EduPlatform - Khôi phục mật khẩu'); // Email và tên người gửi
...
function sendVerificationEmail($email, $code) {
    ...
    try {
        ...
        $mail->Username   = 'win10pro.2004+edu@gmail.com';    // Tài khoản SMTP (email của bạn)
        $mail->Password   = 'esry yozy wwfg kypw'; // Mật khẩu SMTP (Mật khẩu ứng dụng nếu dùng Gmail)
        ...
        // Người gửi và người nhận
        $mail->setFrom('win10pro.2004+edu@gmail.com', 'EduPlatform'); // Email và tên người gửi
