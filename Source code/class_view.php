                            ...
                            <div class="assignment-actions mt-2">
                                ...
                                <?php else: ?>
                                    <?php if (isset($assignment['student_submission_id']) && $assignment['student_submission_id']): ?>
                                         <a href="view_submissions.php?assignment_id=<?php echo $assignment['id']; ?>&submission_id=<?php echo $assignment['student_submission_id']; ?>&student_id=<?php echo $user_id; ?>" class="btn btn-sm btn-success py-1 px-2"><i class="bi bi-file-earmark-check-fill me-1"></i>Xem bài của tôi</a>
